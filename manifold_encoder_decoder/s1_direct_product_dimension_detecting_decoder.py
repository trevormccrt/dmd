...
def train(data, manifold_dim, device, encoder_hidden_dim=1500, encoder_n_hidden=1, decoder_hidden_dim=1500,
    ...
    for i in range(n_training_iterations):
        ...
        nearest_angular_distances, nearest_start, nearest_end, nearest_matches = geometry_util.closest_points_periodic(scrambled_angles)
        ...
        model_arclengths = encoder_net.minimum_straight_line_distance(nearest_start, nearest_end, n_points_integrate=integration_resamples)[1]
